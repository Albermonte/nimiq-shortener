<template>
  <main>
    ...
    <div class="section">
      <section class="container is-fluid box">
              ...
              <div class="columns">
                ...
                <div class="column">
                  <button
                    ...
                    type="button"
                  >{{ button }}</button>
                  <button class="button" v-else type="submit">SHORT IT!</button>
                </div>
              </div>
              <b-collapse :open.sync="url !== '' && !errors.has('url') && !hide">
                <div class="columns">
                  <b-field
                    class="column"
                    label="Nimiq Address"
                  ...
                  <b-field
                    class="column"
                    label="Shares to mine"
                    :type="{'is-danger': errors.has('shares')}"
                    :message="errors.first('shares')"
                  >
                    <b-input
                      icon-pack="fas"
